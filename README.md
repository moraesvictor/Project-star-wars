...
Baseado no projeto da Trybe creie este mesmo depois de algum tempo de experiência front-end
---
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-08-project-starwars-planets-search.git`.
